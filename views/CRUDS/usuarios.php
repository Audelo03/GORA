    ...
    $.get("../../controllers/usuarioController.php?action=index", function(data) {
        ...
        usuarios.forEach(u => {
            ...
            rows += `<tr>
                ...
                <td>
                    <button onclick='editarUsuario(${JSON.stringify(u)})' class="btn btn-sm btn-warning">Editar</button>
                    <button onclick="eliminarUsuario(${u.id_usuario})" class="btn btn-sm btn-danger">Eliminar</button>
                </td>
            </tr>`;
        });
